        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-md border border-slate-100 flex items-start gap-4">
            ...
            <div>
              ...
              <button className="text-sm font-semibold text-blue-600 hover:underline">Download JSON</button>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border border-slate-100 flex items-start gap-4">
            ...
            <div>
              ...
              <button className="text-sm font-semibold text-emerald-600 hover:underline">Generate ZIP</button>
            </div>
          </div>
